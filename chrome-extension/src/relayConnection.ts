...
import {
  ProtocolCommand, ProtocolHandler,
...
export class RelayConnection {
  ...
  // round of `attachTab` invocations. Sends `extension.initialized` so the
  // relay can unblock Browser4 CDP traffic.
  didInitialize(): void {
  ...
  // Called when the UI adds a tab to the Browser4 group. The handler asks
  ...
  // Called when the UI removes a tab from the Browser4 group. We detach the
