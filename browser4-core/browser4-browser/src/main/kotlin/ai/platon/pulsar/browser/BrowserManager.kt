...
/**
 * Compatibility shim for the BrowserManager interface that was moved to
 * [ai.platon.browser4.api.BrowserManager].
 *
 ...
 *
 * All new code should use [ai.platon.browser4.api.BrowserManager] directly.
 */
interface BrowserManager : ai.platon.browser4.api.BrowserManager
