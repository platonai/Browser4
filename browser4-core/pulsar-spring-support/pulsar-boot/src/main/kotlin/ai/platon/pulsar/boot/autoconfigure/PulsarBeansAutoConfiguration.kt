...
import ai.platon.browser4.tools.TikaParser
...
class PulsarBeansAutoConfiguration {
    ...
    fun driverPoolManager(browserManager: BasicBrowserManager, browserFactory: BrowserFactory, conf: MutableConfig): WebDriverPoolManager {
        return WebDriverPoolManager(browserManager, browserFactory, conf, false)
    }
    ...
    fun browserFetcher(
        ...
        return PrivacyManagedBrowserFetcher(browserManager, browserFactory, privacyManager, browserEmulator, conf, false)
    }
