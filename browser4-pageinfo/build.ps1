# build.ps1 — Build, verify, and deploy the browser4-pageinfo plugin
#
# Usage:
...
try {
    Write-Host "[1/3] Building browser4-pageinfo..." -ForegroundColor Cyan
    ...
    # Find the built JAR
    $Jar = Get-ChildItem "target/browser4-pageinfo-*.jar" |
    ...
    $checks = @(
        ...
        @{ Name = "js resource";         Pattern = "pageinfo/extractPageInfo.js" },
        @{ Name = "PageInfoAutoConfiguration";    Pattern = "ai/platon/pulsar/pageinfo/config/PageInfoAutoConfiguration.class" },
        @{ Name = "PageInfoToolExecutor";   Pattern = "ai/platon/pulsar/pageinfo/tools/PageInfoToolExecutor.class" }
    )
