...
tab.ariaSnapshot(viewports: String = "all", boxes: Boolean = false)      // Returns the accessibility tree. viewports: "all", "3", "1,3,5", "2-4". boxes: include bounding box as [box=x,y,width,height]
