...
| 命令 | 说明 |
|---|---|
| `open [url]` | 打开浏览器会话，或重新连接已有会话。支持 `--headed`、`--headless`、`--profile <path>`、`--profile-mode <DEFAULT\|SYSTEM_DEFAULT\|SEQUENTIAL\|TEMPORARY>`、`--interact-level <FASTEST\|FAST\|DEFAULT>`。 |
