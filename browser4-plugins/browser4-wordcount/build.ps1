# build.ps1 — Build, verify, and deploy the browser4-wordcount plugin
#
# Usage:
...
try {
    Write-Host "[1/3] Building browser4-wordcount..." -ForegroundColor Cyan
    ...
    # Find the built JAR
    $Jar = Get-ChildItem "target/browser4-wordcount-*.jar" |
    ...
    $checks = @(
        ...
        @{ Name = "js resource";         Pattern = "my/doAction.js" },
        @{ Name = "WordcountAutoConfiguration";    Pattern = "ai/platon/pulsar/my/config/WordcountAutoConfiguration.class" },
        @{ Name = "WordcountToolExecutor";   Pattern = "ai/platon/pulsar/my/tools/WordcountToolExecutor.class" }
    )
