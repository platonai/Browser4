# build.ps1 — Build, verify, and deploy the browser4-linkstats plugin
#
# Usage:
...
try {
    Write-Host "[1/3] Building browser4-linkstats..." -ForegroundColor Cyan
    ...
    # Find the built JAR
    $Jar = Get-ChildItem "target/browser4-linkstats-*.jar" |
    ...
    $checks = @(
        ...
        @{ Name = "js resource";         Pattern = "linkstats/summarize.js" },
        @{ Name = "LinkstatsAutoConfiguration";    Pattern = "ai/platon/pulsar/linkstats/config/LinkstatsAutoConfiguration.class" },
        @{ Name = "LinkstatsToolExecutor";   Pattern = "ai/platon/pulsar/linkstats/tools/LinkstatsToolExecutor.class" }
    )
