# build.ps1 — Build, verify, and deploy the browser4-pagetitle plugin
#
# Usage:
...
try {
    Write-Host "[1/3] Building browser4-pagetitle..." -ForegroundColor Cyan
    ...
    # Find the built JAR
    $Jar = Get-ChildItem "target/browser4-pagetitle-*.jar" |
    ...
    $checks = @(
        ...
        @{ Name = "js resource";         Pattern = "pagetitle/getPageInfo.js" },
        @{ Name = "PagetitleAutoConfiguration";    Pattern = "ai/platon/pulsar/pagetitle/config/PagetitleAutoConfiguration.class" },
        @{ Name = "PagetitleToolExecutor";   Pattern = "ai/platon/pulsar/pagetitle/tools/PagetitleToolExecutor.class" }
    )
