# build.ps1 — Build, verify, and deploy the browser4-forms plugin
#
# Usage:
...
try {
    Write-Host "[1/3] Building browser4-forms..." -ForegroundColor Cyan
    ...
    # Find the built JAR
    $Jar = Get-ChildItem "target/browser4-forms-*.jar" |
    ...
    $checks = @(
        ...
        @{ Name = "js resource";         Pattern = "forms/detectForms.js" },
        @{ Name = "FormsAutoConfiguration";    Pattern = "ai/platon/pulsar/forms/config/FormsAutoConfiguration.class" },
        @{ Name = "FormsToolExecutor";   Pattern = "ai/platon/pulsar/forms/tools/FormsToolExecutor.class" }
    )
