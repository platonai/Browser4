# build.ps1 — Build, verify, and deploy the browser4-linkcheck plugin
#
# Usage:
...
try {
    Write-Host "[1/3] Building browser4-linkcheck..." -ForegroundColor Cyan
    ...
    # Find the built JAR
    $Jar = Get-ChildItem "target/browser4-linkcheck-*.jar" |
    ...
    $checks = @(
        ...
        @{ Name = "js resource";         Pattern = "linkcheck/countLinks.js" },
        @{ Name = "LinkcheckAutoConfiguration";    Pattern = "ai/platon/pulsar/linkcheck/config/LinkcheckAutoConfiguration.class" },
        @{ Name = "LinkcheckToolExecutor";   Pattern = "ai/platon/pulsar/linkcheck/tools/LinkcheckToolExecutor.class" }
    )
