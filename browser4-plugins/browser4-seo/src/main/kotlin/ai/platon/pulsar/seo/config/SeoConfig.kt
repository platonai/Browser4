...
/**
 * Configuration holder for the browser4-seo plugin.
 *
 * All properties are read from [ImmutableConfig] with the `seo.` prefix
...
data class SeoConfig(
    ...
    companion object {
        private const val PREFIX = "seo."

        fun fromConfig(conf: ImmutableConfig): SeoConfig = SeoConfig(
