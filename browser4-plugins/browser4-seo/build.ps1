# build.ps1 — Build, verify, and deploy the browser4-seo plugin
#
# Usage:
...
try {
    Write-Host "[1/3] Building browser4-seo..." -ForegroundColor Cyan
    ...
    # Find the built JAR
    $Jar = Get-ChildItem "target/browser4-seo-*.jar" |
    ...
    $checks = @(
        ...
        @{ Name = "extract-meta.js";     Pattern = "seo/extract-meta.js" },
        @{ Name = "check-issues.js";     Pattern = "seo/check-issues.js" },
        @{ Name = "SeoAutoConfiguration"; Pattern = "ai/platon/pulsar/seo/config/SeoAutoConfiguration.class" },
        @{ Name = "SeoToolExecutor";      Pattern = "ai/platon/pulsar/seo/tools/SeoToolExecutor.class" }
    )
