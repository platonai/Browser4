# build.ps1 — Build, verify, and deploy the browser4-weather plugin
#
# Usage:
...
try {
    Write-Host "[1/3] Building browser4-weather..." -ForegroundColor Cyan
    ...
    # Find the built JAR
    $Jar = Get-ChildItem "target/browser4-weather-*.jar" |
    ...
    $checks = @(
        ...
        @{ Name = "js resource";         Pattern = "weather/fetchWeather.js" },
        @{ Name = "WeatherAutoConfiguration";    Pattern = "ai/platon/pulsar/weather/config/WeatherAutoConfiguration.class" },
        @{ Name = "WeatherToolExecutor";   Pattern = "ai/platon/pulsar/weather/tools/WeatherToolExecutor.class" }
    )
