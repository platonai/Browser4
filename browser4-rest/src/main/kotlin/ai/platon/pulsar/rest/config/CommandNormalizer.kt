...
/**
 * Interface for normalizing plain text commands into structured [ai.platon.pulsar.agentic.tools.advanced.crawl.PageVisitRequest] objects.
 *
...
fun interface CommandNormalizer {
    /**
     * Normalize a plain text command into a [ai.platon.pulsar.agentic.tools.advanced.crawl.PageVisitRequest].
     *
     * @param plainCommand The plain text command to normalize.
     * @return A [ai.platon.pulsar.agentic.tools.advanced.crawl.PageVisitRequest] if the command can be normalized, null otherwise.
     */
