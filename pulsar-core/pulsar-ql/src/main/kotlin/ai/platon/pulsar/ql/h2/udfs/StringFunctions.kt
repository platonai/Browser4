...
/**
 * User-defined functions for string manipulation in H2 SQL queries.
 *
 * This object provides a comprehensive set of string utility functions that can be used
 * in SQL queries. Most functions are wrappers around Apache Commons Lang StringUtils,
 * making them available in the SQL context with the "STR" namespace prefix.
 *
 * Example usage in SQL:
 * ```sql
 * SELECT STR_UPPER_CASE(name) FROM table;
 * SELECT STR_SUBSTRING(text, 0, 10) FROM table;
 * ```
 *
...
object StringFunctions {
    ...
    // ========================================
    // String Searching - Index Operations
    // ========================================
...
//    @UDFunction @JvmStatic fun lastIndexOf(str: String?, arg1: Int, arg2: Int): Int = StringUtils.lastIndexOf(str, arg1, arg2)
    ...
    @UDFunction
    @JvmStatic
    fun lastIndexOfIgnoreCase(str: String?, arg1: String, arg2: Int): Int = StringUtils.lastIndexOfIgnoreCase(str, arg1, arg2)
    ...
    // ========================================
    // String Searching - Contains Operations
    // ========================================
    ...
    // ========================================
    // String Searching - Starts/Ends Operations
    // ========================================
...
//    @UDFunction @JvmStatic fun repeat(str: Char, arg1: Int): String? = StringUtils.repeat(str, arg1)
    ...
    @UDFunction
    @JvmStatic
    fun getLevenshteinDistance(str: String?, arg1: String, arg2: Int): Int = StringUtils.getLevenshteinDistance(str, arg1, arg2)
    ...
    @UDFunction
    @JvmStatic
    fun appendIfMissing(str: String?, arg1: String, arg2: Array<String>): String? = StringUtils.appendIfMissing(str, arg1, *arg2)

    @UDFunction
    @JvmStatic
    fun appendIfMissingIgnoreCase(str: String?, arg1: String, arg2: Array<String>): String? = StringUtils.appendIfMissingIgnoreCase(str, arg1, *arg2)

    @UDFunction
    @JvmStatic
    fun prependIfMissing(str: String?, arg1: String, arg2: Array<String>): String? = StringUtils.prependIfMissing(str, arg1, *arg2)

    @UDFunction
    @JvmStatic
    fun prependIfMissingIgnoreCase(str: String?, arg1: String, arg2: Array<String>): String? = StringUtils.prependIfMissingIgnoreCase(str, arg1, *arg2)
    ...
    // ========================================
    // Custom Numeric Extraction Functions
    // ========================================

    /**
     * Extracts the first integer found in the given string.
     *
     * @param str The string to search for an integer
     * @param defaultValue The value to return if no integer is found
     * @return The first integer found, or the default value if none exists
     */
    ...
    /**
     * Extracts the first float number found in the given string.
     *
     * @param str The string to search for a float number
     * @param defaultValue The value to return if no float is found
     * @return The first float found, or the default value if none exists
     */
    ...
    /**
     * Extracts the first float number found in the given string.
     * This is an alias for firstFloat with a more descriptive name.
     *
     * @param str The string to search for a float number
     * @param defaultValue The value to return if no float is found
     * @return The first float found, or the default value if none exists
    ...
    @JvmStatic
    fun getFirstFloatNumber(str: String?, defaultValue: Float): Float = Strings.getFirstFloatNumber(str, defaultValue)
}
