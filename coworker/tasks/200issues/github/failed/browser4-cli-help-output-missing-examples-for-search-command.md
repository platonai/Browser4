...
The help output lists flags and arguments but provides no examples showing how to construct real commands. First-time users must experiment or read source code to understand correct syntax.

## Suggested Improvement

Add an **Examples** section to the help output for each command, following the convention established by widely-used CLI tools such as `curl`, `git`, and `docker`. Each example should show a realistic command invocation and a brief description of what it does.
