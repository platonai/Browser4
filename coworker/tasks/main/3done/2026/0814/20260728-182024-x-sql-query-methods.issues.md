...
| Issue | Status | Change |
|---|---|---|
| 1 (diagnostic leaks to stdout) | Fixed | "Finding browser4 root" message no longer present |
| 2 (inline --sql quoting) | Docs covered | shell-quoting.md documents single-quote/@file patterns |
| 3 (inspect h3>a suggestion) | Deferred | low-priority UX |
| 4 (@url placeholder docs) | Docs covered | x-sql.md documents the @url placeholder |
| 5 (:expr() explanation) | Deferred | low-priority docs |
| 6 (book title truncation) | Deferred | likely page-level CSS ellipsis; needs investigation |
| 7 (help category) | Deferred | low-priority UX |
