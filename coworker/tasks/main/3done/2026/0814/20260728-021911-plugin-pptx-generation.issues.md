...
| Issue | Status | Change |
|---|---|---|
| 1 (POI deps not bundled) | Fixed | plugin is a source module now (browser4-plugins/browser4-pptx), deps in pom |
| 2 (30s timeout) | Partial | global --timeout flag overrides |
| 3 (no plugin docs) | Deferred | docs |
| 4 (read source to discover) | Deferred | discoverability |
| 5 (dynamic command drops args) | Fixed | resolve_plugin_method + arg forwarding |
| 6 (image download slow) | Deferred | UX |
| 7 (unhelpful load error) | Deferred | UX |
| 8 (presentation.pptx name) | Deferred | UX |
