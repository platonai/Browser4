...
| Issue | Status | Change |
|---|---|---|
| 1 (eval --ref null) | Fixed | CLI detects non-arrow expressions under --ref and suggests `element => element.x` |
| 2 (PowerShell short flags) | Fixed | b4w.ps1 manual arg parsing |
| 3 (eval --help --ref docs) | Deferred | docs |
| 4 (console.log not visible) | Deferred | UX |
| 5 (grep discoverability) | Deferred | docs |
| 6 (ref lifecycle docs) | Deferred | docs |
