...
**Commands used:** `./b4w.ps1 help`, `help crawl`, `crawl` (×~10 variants), `crawl result <taskId>`, `htmlsnapshot query`. Prepared `seed.txt` + `extract.sql` in the run scratch dir; verified target pages by HTTP status and markup before crawling.
