    ...
    private fun wireAllMounts(mounts: List<PluginMount>) {
        ...
        for (mount in mounts) {
            when {
                ...
                // --- Tool mount ---
                mount is ToolMount -> wireToolMount(mount)

                // --- Page sniffer mount ---
                mount is PageSnifferMount -> wirePageSnifferMount(mount)
            }
        }
    }
